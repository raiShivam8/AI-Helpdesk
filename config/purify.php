    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title|target],ul,ol,li,p[style],br,span,img[width|height|alt|src|class|style],blockquote,div[class|style]',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align,width,height,max-width,max-height',
            'URI.AllowedSchemes' => [
                'http' => true,
                'https' => true,
                'mailto' => true,
