                ...
                <header class="sticky top-0 z-30 backdrop-blur-md border-b h-16 flex items-center px-4 sm:px-6 gap-3 shrink-0 bg-white/95 dark:bg-[#161B27]/95 border-slate-200/80 dark:border-slate-800 shadow-xs">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3">
                        ...
                        <a href="{{ route('dashboard', ['agent_id' => Auth::id()]) }}"
                           class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 dark:bg-indigo-900/40 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 text-indigo-700 dark:text-indigo-300 text-xs font-bold rounded-xl border border-indigo-200 dark:border-indigo-700/60 shadow-2xs transition-colors"
                        ...
                        <div x-data="{
                            ...
                            <div x-show="open"
                                 ...
                                 class="notif-card absolute right-0 top-full mt-2 w-80 sm:w-96 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-2xl z-50 overflow-hidden"
                                 x-cloak>
