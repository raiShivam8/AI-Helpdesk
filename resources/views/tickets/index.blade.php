<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
        ...
        <div class="flex items-center gap-2">
            <form action="{{ route('tickets.sync-emails') }}" method="POST" x-data="{ syncing: false }" @submit="syncing = true">
                @csrf
                            ...
                            <td class="max-w-[280px]">
                                <div class="flex items-center gap-1.5 flex-wrap">
                                    <a href="{{ route('tickets.show', $ticket) }}"
                                       class="font-semibold text-slate-900 dark:text-slate-100 hover:text-indigo-600 dark:hover:text-indigo-400 truncate transition-colors duration-150"
